...
resolvers += GCSResolver.forBucket("wojnowski-291318-maven-repository")
ThisBuild / publishTo := Some(GCSPublisher.forBucket("wojnowski-291318-maven-repository", AccessRights.InheritBucket))
